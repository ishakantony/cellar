...
describe('collections actions', () => {
    ...
    it('should return collection with assets', async () => {
      ...
      const mockCollection = {
        ...
        assets: [
          ...
          {
            ...createMockAssetCollection({ assetId: 'asset-2', collectionId: 'collection-1' }),
            asset: mockAsset2,
          },
        ],
        _count: { assets: 2 },
  ...
  describe('toggleCollectionPin', () => {
    ...
    it('should throw error when collection not found', async () => {
      ...
      await expect(toggleCollectionPin('non-existent')).rejects.toThrow(
  ...
  describe('addAssetToCollection', () => {
    ...
    it('should throw error when asset not found', async () => {
      ...
      await expect(addAssetToCollection('non-existent', 'collection-1')).rejects.toThrow(
        'Resource not found or access denied'
      );
    ...
    it('should throw error when collection not found', async () => {
      ...
      await expect(addAssetToCollection('asset-1', 'non-existent')).rejects.toThrow(
        'Resource not found or access denied'
      );
  ...
  describe('removeAssetFromCollection', () => {
    ...
    it('should throw error when asset not found', async () => {
      ...
      await expect(removeAssetFromCollection('non-existent', 'collection-1')).rejects.toThrow(
        'Resource not found or access denied'
      );
    ...
    it('should throw error when collection not found', async () => {
      ...
      await expect(removeAssetFromCollection('asset-1', 'non-existent')).rejects.toThrow(
        'Resource not found or access denied'
      );
    ...
    it('should throw error when user is not authenticated', async () => {
      ...
      await expect(removeAssetFromCollection('asset-1', 'collection-1')).rejects.toThrow(
        'Unauthorized'
      );
