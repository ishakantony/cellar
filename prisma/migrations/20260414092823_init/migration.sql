-- CreateEnum
CREATE TYPE "AssetType" AS ENUM ('SNIPPET', 'PROMPT', 'NOTE', 'LINK', 'IMAGE', 'FILE');
...
-- CreateIndex
CREATE INDEX "Asset_userId_pinned_idx" ON "Asset"("userId", "pinned");

-- CreateIndex
CREATE INDEX "Asset_userId_updatedAt_idx" ON "Asset"("userId", "updatedAt" DESC);

-- CreateIndex
CREATE INDEX "Collection_userId_pinned_idx" ON "Collection"("userId", "pinned");
